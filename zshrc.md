...
I have started using [zsh4humans](https://github.com/romkatv/zsh4humans) and for now, this section is a dump of the default configuration until I untangle everything
...
Sometimes I use an older version of Terraform outside of `mise` that doesn't support ARM builds
