...
#+RESULTS:
: /media/marcus/Storage/Dropbox/org/gtd/
  ...
  (setq org-roam-capture-templates
        '(("d" "default" plain (function org-roam--capture-get-point)
          ...
          ("B" "blog post" plain (function org-roam--capture-get-point)
           ...
           :head "#+TITLE: ${title}\n#ROAM_TAG: post\n\n")
          ("r" "gtd review" plain (function org-roam--capture-get-point)
           "%?"
           :file-name "reviews/${slug}_review-private"
           :head "#+TITLE: ${title} Review\n#ROAM_TAG: gtd review\n\n* What went well this week?\n\n* What could be adjusted?\n\n* What should I stop doing\n\n* What should I start doing?\n"))))
#+end_src
