...
I've had troubles with ~auth-password-store~ so this is the next best thing

#+begin_src emacs-lisp
(setq gcal-client-id (getenv "GCAL_CLIENT_ID"))
(setq gcal-client-secret (getenv "GCAL_CLIENT_SECRET"))
(setq gcal-cal-id (getenv "GCAL_CAL_ID"))
#+end_src
...
(setq utf9k-notes (concat workspace "/utf9k/content-org/notes/"))
...
(use-package! org-roam
  ...
  (setq org-roam-directory utf9k-notes
...
(use-package deft
  ...
  :custom
  (deft-recursive t)
  (deft-ignore-file-regexp "hugo_setup.org")
  (deft-use-filter-string-for-filename t)
  (deft-default-extension "org")
  (deft-directory utf9k-notes))
#+end_src
    ...
    (setq
      ...
      org-caldav-calendars `(
        (:calendar-id "d9a65464-ff38-426f-b615-6accd279b1b1"
         :sync 'cal->org
         :inbox ,(concat org-agenda-directory "personal.org")))
...
(use-package! org-gcal
  ...
  (setq
    ...
    org-gcal-file-alist `((,gcal-cal-id . ,(concat org-agenda-directory "work.org")))))
#+end_src
