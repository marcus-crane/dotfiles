...
#+end_src
** Netocean
I store all of my org files on a [[https://www.synology.com/en-nz/products/DS220j][Synology DS220j]] at my house, which has redudancy thanks to RAID and just to be extra safe, also syncs content with Dropbox as a backup point.
