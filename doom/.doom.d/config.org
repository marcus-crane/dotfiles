...
I store all of my org files in Dropbox

#+begin_src emacs-lisp
(setq storage "~/Dropbox")
#+end_src
** Useful bits
*** I'd like to see the time while inside Emacs
...
*** I don't need to know that we're using UTF-8
...
#+end_src
* Org mode
In an attempt to stay sane, I've banned myself from configuring Emacs (especially org mode) to do anything interesting

I might use TODOs in various files but I'm not using Emacs as a TODO list, zettelkasten, agenda or anything like that

If you spot me doing doing that, please submit a pull request to delete my config
...
#+end_src
** Which org files should be checked for TODOs?
The answer is ideally all of them

#+begin_src emacs-lisp
(setq org-agenda-files (directory-files-recursively org-directory "\\.org$"))
#+end_src
** How can I search through my notes?
#+begin_src emacs-lisp
(use-package deft
  :after org
  :custom
...
#+end_src
* Beacon
I'm blind so I'd like to be reminded where my cursor is most of the time
...
#+end_src
* Fish
My current shell of choice but by default, Emacs reads its configuration as ~Fundamental~ mode
